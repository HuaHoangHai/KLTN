        ...
        <div className='hidden md:flex w-full h-full item-center justify-between'>
            ...
            <div className='flex items-center gap-8'>
                ...
                <div className='relative'>
                    <motion.img whileTap={{ scale: 0.7 }} src={user ? user.photoURL : avatar} alt="avatar" className='w-10 min-w-[40px] h-10 min-h-[40px] drop-shadow-2xl rounded-full cursor-pointer'
                        onClick={login}
                    />
                    {
                        isMenu && (
