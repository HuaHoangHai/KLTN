...
const HomeContainer = () => {
  return (
    ...
    <div className='w-full flex items-center justify-center relative'>
         <img className="ml-auto w-full h-420 lg:w-auto lg:h-650" src={HeroBg} alt="" />
      ...
      {heroData && heroData.map(
        n=>(
            ...
            <p className="text-base lg:text-lg mt-2 lg:mt-4 font-semibold text-textColor  my-1"> {n.name}</p>
